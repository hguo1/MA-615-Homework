...
## Slide with Highway Plot {.smaller}
```{r include= TRUE,message = FALSE}
 ggplot(mpg) +
 aes(x = displ, y = hwy) +
 geom_point(aes(color=class),size=2) + geom_smooth() +
